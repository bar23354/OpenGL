...
class Renderer(object):
    ...
    def Render(self):
        ...
        if self.activeShader is not None:
            ...
            glUniform1i( glGetUniformLocation(self.activeShader, "tex3"), 3)
            glUniform1i( glGetUniformLocation(self.activeShader, "tex4"), 4)
            glUniform1i( glGetUniformLocation(self.activeShader, "tex5"), 5)
            glUniform1i( glGetUniformLocation(self.activeShader, "tex6"), 6)
        ...
        for obj in self.scene:
            ...
            if self.activeShader is not None:
                ...
                locUseMat = glGetUniformLocation(self.activeShader, "useMatId")
                if locUseMat != -1:
